...
export const devices = {
    ...
    ipad7th: `only screen and (min-device-width: 897px) and (max-device-width: 1080px) and (orientation: landscape) and (-webkit-min-device-pixel-ratio: 2) `,
    ipad: `only screen and (min-device-width: 1068px) and (max-device-width: 1112px) and (orientation: landscape) and (-webkit-min-device-pixel-ratio: 2)`,
